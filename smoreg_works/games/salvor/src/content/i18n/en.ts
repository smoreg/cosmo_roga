...
export const EN = {
  ...
  "hint.training": "TRAINING. The first hull of this voyage is built to be learned on. Seven lines aboard it, one at a time.",
  "hint.tutorial.enter": "TRAINING HULL. Small, quiet, and short of anything that can end a run. Everything the drone can do is the numbered list.",
  "hint.tutorial.scan": "Press s for a SCANNER pulse: it reads the compartments behind the doors before you walk into them.",
  "hint.tutorial.contact": "A machine. Attacking it is a numbered action, and so is walking away — nothing aboard follows you home.",
  "hint.tutorial.door": "A locked bulkhead. Its keycard is on a body this side of it: search the dead, or cut the door open.",
  "hint.tutorial.system": "Raising a system takes several turns in a row and makes noise. Whatever is still aboard hears it and comes.",
  "hint.tutorial.airlock": "The airlock. Stepping out banks what the drone carries and leaves the ship exactly as it stands.",
  "hint.tutorial.sale": "That is the lesson. The next hull is not one: jump when the account can pay for the drone after this.",
  ...
  "codex.alert-4.what": "The ship sends its hunter. It comes looking, cuts through what you welded shut, and finds you in cover.",
  ...
  "codex.blade.what": "Two dice where the cutter has one, and it opens a bulkhead exactly as a cutter does.",
  ...
  "codex.shocker.what": "Three charges, and each one is silence in this compartment for two turns, machines included.",
  ...
  "codex.lattice.what": "Thirty integrity, and the only flat point of armour anywhere in the game.",
