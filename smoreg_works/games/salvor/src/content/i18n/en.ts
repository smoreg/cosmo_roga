...
export const EN = {
  ...
  "log.scrap.drop": "{machine} dies, leaving a {module} in the wreck.",
  "log.hit.module.burn": "{source}: hit. {burn}",
  ...
  "log.work.break": "You break off {job}. {done} of {of} turns, gone.",
  "job.splice": "the splice",
  "job.cut": "the cut",
  "job.weld": "the weld",
  "job.defuse": "the defusing",
  "job.ram": "the ramming",
  "job.purge": "the purge",
  "job.upload": "the upload",
  ...
  "log.pulse.found": "Sensor pulse. A sealed crate in {rooms}, with something standing over {n, one: it, other: them}.",
  ...
  "codex.alert-8.helps": "A CELL opens a lock in one turn and a point of itself; a SPIKE takes two, a cutter three.",
