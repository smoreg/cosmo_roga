...
export const RU: Table = {
  ...
  "burn.thrusters": "ДВИГАТЕЛИ выгорели. Дальше — ползком.",
  "burn.scanner": "СКАНЕР выгорел. За этой дверью корабль гаснет.",
  "burn.plating": "БРОНЯ выгорела. Следующий удар — в ядро.",
  "burn.cell": "БАТАРЕЯ выгорела. Переборки придётся резать.",
  "burn.emp": "ЭМИ выгорел. Заряд умер в катушке.",
  "burn.welder": "СВАРКА выгорела. Починок в поле не будет.",
  "burn.laser": "ЛАЗЕР выгорел. Линза помутнела намертво.",
  "burn.spike": "ОТМЫЧКА выгорела. Что заперто, то заперто.",
  "burn.emitter": "ЭМИТТЕР выгорел. Теперь только вплотную.",
  "burn.baffle": "ГАСИТЕЛЬ выгорел. Корабль снова тебя слышит.",
  "burn.blade": "К-КЛИНОК выгорел. Второго такого нет.",
  "burn.shocker": "ШОКЕР выгорел. Таких нигде не продают.",
  "burn.lattice": "РЕШЁТКА выгорела. Удар больше не отвести.",
  ...
  // Строка, которая уводит буксир дальше. Контракт назван вместе с корпусом:
  // отдельной строки контрактов с G90 F нет, а владелец её искал (G92 B1).
  "action.pick.berth": "корпус и контракт ▸",
  "action.pick.berthHere": "корпус и контракт здесь ▸",
  "action.pick.jump": "корпус и контракт {price} CR ▸",
  ...
  "log.door.ram.on": "Таран {door}. Ещё {left, one: # ход, few: # хода, many: # ходов}.",
  ...
  "log.scrap.drop": "{machine} гибнет. Лом: {module}.",

  "log.door.key": "Ключ-карта: {door} открыта.",
  "log.door.power": "БАТАРЕЯ в {door}: замок отпускает.",
  "log.door.cut.on": "Рез {door}. Ещё {left, one: # ход, few: # хода, many: # ходов}.",
  ...
  "log.upload.on": "Загрузка идёт. Ещё {left, one: # ход, few: # хода, many: # ходов}.",
  ...
  "log.carry.take": "{module} {left}/{max} снят, {n}/{limit}.",
  "log.carry.home": "Донесено: {n}. В трюм.",
  "log.salvage.graft": "Наращивание: {module} {left}/{max}.",
  ...
  "log.relic.take": "Реликвия: {module}. Не чинится, не продаётся.",
  ...
  "log.system.work.hands": "{system} руками, шумно. Ещё {left, one: # ход, few: # хода, many: # ходов}.",
  "log.system.advance": "Чартер платит аванс:",
  "log.system.all": "Все три запущены. `<` — выход через шлюз, корпус продаётся.",
  "log.system.all.paid": "Все три запущены. `<` — выход через шлюз: +{cr} CR.",

  "log.alert.hunter": "{hunter} просыпается: {room}.",
  "log.alert.busy": "Ещё {n, one: # машина, few: # машины, many: # машин} на борту.",
  ...
  "log.alert.down": "Корабль обезврежен: больше не отвечает.",
  ...
  "word.blown": "разнесён",
  "log.alert.charge": "Заряд: {room}, {n, one: # ход, few: # хода, many: # ходов}.",
  "log.alert.fuse": "Заряд в {room}: {n}.",
  "log.alert.blast": "{room} взрывается: ничего не осталось.",
  "log.alert.blast.you": "Заряд рвёт под тобой.",
  "log.alert.detonation":
    "ДЕТОНАЦИЯ: {n, one: # ход, few: # хода, many: # ходов}. Не выживет никто.",
  "log.alert.boom": "Корабль детонирует.",
  ...
  "log.hull.bought": "{hull} куплен: {trait}. Осталось {credits} CR.",
  "log.hull.tow": "{hull} на буксир:",
  "log.hull.tow.split": "{hull} на буксир, продажа пополам:",
  ...
  "log.voyage.home": "Шлюз отработал. Дереликт ещё стоит.",
  ...
  "log.drone.lost": "Дрон потерян. Груз остался на борту.",

  // ---------------------------------------------------------------- подсказки

  "hint.exposure": "Удар приходится по тому, что ты только что использовал.",
  "hint.burned": "Сгоревший модуль не вернуть никогда.",
  "hint.scrap": "Лом: разбери на модуль или нарасти им свой.",
  "hint.blind": "Без СКАНЕРА виден только этот отсек.",
  "hint.keycard": "Ключ-карта. Двери с меткой [ ] её читают.",
  "hint.death": "Твой мёртвый дрон всё ещё там, и он враг.",
  "hint.objective": "Система корабля. Запусти все три и уйди живым — корпус продадут.",
  "hint.payout": "Платят только за то, что дрон вынес через шлюз.",
  "hint.mouse": "Мышь работает: клик по строке или по отсеку.",
  "hint.sold": "Трюм продан за {credits} CR. Корпус стоит {hullPrice}.",
  "hint.shooting": "Стреляешь — ответ придёт в ЭМИТТЕР.",
  "hint.sell": "Продано насовсем. Что беречь — снимай в трюм.",
  "hint.virus": "Вирус в ломе — смотри в панели. Чистка: {turns} ходов, {spike} — {fast}.",
  ...
  "airlock.card.title": "ВСЕ 3 ЗАПУЩЕНЫ — ТЕПЕРЬ НА ВЫХОД",
  "airlock.card.worth": "{hull} стоит {cr} CR, как только уйдёт на буксире.",
  "airlock.card.worth.bare": "{hull} готов уйти на буксире.",
  "airlock.card.paid": "Пока дрон внутри, не платят ни кредита. Корпус продан — и трюм вместе с ним — когда дрон выйдет через шлюз; за дрон, который не вышел, не платят ничего.",
  "airlock.card.press": "Жми `<` — дрон дойдёт до шлюза, и `<` ещё раз — выход.",
  "airlock.card.footer": "любая клавиша закрывает",
  ...
  "why.jump.held": "{hull} ещё на месте. Сначала взять на буксир или дать взорваться, потом прыжок.",
  ...
  // Имя строки и та же строка со списком недоделанного в скобках — пометкой под
  // строкой, а не именем её (G92 B2).
  "action.undock": "проникновение на дереликт",
  "action.undock.todo": "проникновение на дереликт ({left})",
  "undock.left.damaged": "чинить {n, one: # модуль, few: # модуля, many: # модулей}",
  "undock.left.charter": "выбор",
  "undock.left.board": "выбор закроется",
  ...
  "rack.read.hp": "ПРОЧНОСТЬ {left}/{max}",
  "rack.read.charges": "ЗАРЯДОВ {n}",
  "rack.read.graft": "+{n} нарощено на верстаке, сверх каталожной прочности. Больше {max} не берёт ни один модуль.",
  "rack.read.exposed": "◀ следующий удар придётся в этот слот.",
  "rack.read.virus": "{virus} работает в этом слоте.",
  "rack.does.thrusters": "Полная скорость хода. Сгорят — дрон ползёт, и всё на борту получает лишние ходы.",
  "rack.does.plating": "Принимает удар раньше ядра: через этот модуль проходит каждое попадание по дрону.",
  "rack.does.laser": "Удар тяжелее, чем у резака, и против переборки бесполезен.",
  "rack.does.baffle": "Тише шаги и короче взгляд у того, кто смотрит: корабль замечает тебя позже.",
  "panel.keys": "КЛЮЧЕЙ {n}",
  ...
  "panel.goal.noTool": "НЕТ МОДУЛЯ: РУКАМИ / < ДОМОЙ",
  ...
  "help.where.tug.3": "Здесь нет ни часов, ни тревоги: дома ничто не движется.",
  ...
  "log.opening.tug": "Твой буксир: дрон, ремонт, чартеры, вылет — всё в списке. ? — справка.",
  "log.opening.voyage":
  ...
  "lesson.brief.title": "РАБОТА",
  "lesson.brief.hull": "Дереликт: мёртвый корпус в дрейфе, машины на нём ещё не спят, а твой дрон подключён к нему с буксира.",
  "lesson.brief.job": "Работа всегда одна. Поднять три системы корпуса — ПРИВОД, РЕАКТОР, ТЕРМИНАЛ — и вывести дрон через шлюз.",
  "lesson.brief.pay": "Потом буксир уводит корпус и продаёт его. Это вся игра. Урок показывает каждый ход по разу; окно в углу говорит, что нажать.",
  "lesson.brief.footer": "любая клавиша — урок начинается",
  ...
  "lesson.over": "Так домой пришёл первый дрон. Буксир теперь твой: 1 — выбрать настоящий дереликт и контракт.",
  ...
  "lesson.fight": "Замок разбудил разведчика, он идёт к тебе. Tab — сблизиться и ударить, нажатие — удар. Его удар приходит в модуль, которым ты действовал последним; ядро — когда стойка кончилась.",
  "lesson.fight.press": "клавиша Tab",
  "lesson.scan": "Жми s: сенсорный импульс читает корабль на две двери вперёд сквозь закрытые переборки и показывает, что там стояло в этот миг. Стоит хода, и он громкий: слышит весь корабль.",
  "lesson.scan.press": "s",
  ...
  "lesson.virus": "ОТМЫЧКА из ящика принесла корабельный вирус — так бывает с любым ломом. Прочти его карточку (v), потом жми строку «чистка», пока не очистится; с ОТМЫЧКОЙ чистка вдвое короче.",
  "lesson.virus.press": "строка «чистка» · v",
  "lesson.systems": "Три системы, по одной на отсек: в каждом жми «подъём». ПРИВОД — РЕЗАК, РЕАКТОР — БАТАРЕЯ, ТЕРМИНАЛ — ОТМЫЧКА или ключ. Все три — корпус продан. Нет модуля? Руками: долго и громко.",
  "lesson.systems.press": "строка «подъём» · в МОТОРАХ, РЕАКТОРЕ, МОСТИКЕ",
  "lesson.leave": "Все три подняты: назад к шлюзу и наружу. Жми < — дрон дойдёт до него, и < ещё раз — выход. Потом буксир уводит корпус и платит за него; пока дрон внутри, не платят ничего.",
  "lesson.leave.press": "<",
  ...
  "help.charter.1": "Один на корпус, подписывается на строке этого корпуса;",
  ...
  "help.charter.5": "Нет модуля? Можно руками: долго и очень громко.",
  "help.dock.head": "СТРОКИ БУКСИРА — что делает каждая группа",
  "help.dock.1": "1 корпус и контракт: куда лететь и за что платят.",
  "help.dock.2": "2 проникновение: дрон уходит на выбранный корпус.",
  "help.dock.3": "3 покупка дрона: без дрона на рельсах вылета нет.",
  "help.dock.4": "Дальше стойка: ремонт, установка из трюма и с полки,",
  "help.dock.5": "съём в трюм, продажа насовсем, чистка от вируса.",
  "help.voyage.head": "РЕЙС — три точки, последняя — буксир отца",
  "help.voyage.1": "Три точки; на каждой выбираешь, куда лететь дальше.",
  "help.voyage.2": "Последний корпус — буксир отца: увёл его — победа.",
  "help.voyage.3": "За корпус платят, только когда дрон выйдет наружу.",
  ...
  "end.sold": "ДЕРЕЛИКТ ОБЕЗВРЕЖЕН И ПРОДАН",
  "end.sold.why": "{hull}: все {n} запущены, корпус ушёл на буксире. +{cr} CR на счёт.",
  "end.sold.why.bare": "{hull}: все {n} запущены, корпус ушёл на буксире.",
  ...
  // Три группы, в порядке и словами владельца (G92 B1). Группы, а не отсеки:
  // ДОК, ТРЮМ, СТЕНД и РУБКА — это внутренности корабля, и по ним нельзя
  // угадать, где чинят модуль (docs/tasks/G53-tug-is-a-menu.md, 1).
  "tug.group.voyage": "РЕЙС",
  "tug.group.drone": "ПОКУПКА ДРОНОВ",
  "tug.group.rig": "СТОЙКА",

  "action.pick.buy": "купить корпус ▸",
  "action.dead.undock": "проникновение на дереликт",
  ...
  "engine.hit.you": "Удар: {target} -{amount} ({hp}/{max}).",
  "engine.hit.taken": "{Actor}: удар, -{amount}.",
  "engine.hit.other": "{Actor} → {target}: урон {amount} ({hp}/{max}).",
  "engine.dies": "{Target} гибнет.",
  "engine.cover.you": "В укрытии.",
  "engine.cover.other": "{Actor}: в укрытии.",
  ...
  "log.hazard.tell.frost": "ОПАСНОСТЬ: {door} → {room}, лёд. Двигатели вязнут. [i]",
  "log.hazard.tell.smoke": "ОПАСНОСТЬ: {door} → {room}, дым. Никто ничего не видит. [i]",
  "log.hazard.tell.mine": "ОПАСНОСТЬ: {door} заминирована. Рванёт под первым. [i]",
  ...
  // ------------------------------------- собственные надписи четвёртого вида

  "word.crShort": "CR",

  "react.rail.menu": "меню",
  "react.rail.sound": "звук {state}",
  "react.paused": "пауза",
  "react.close": "закрыть",
  "react.core": "ядро",
  "react.slot.empty": "пусто",

  "react.stat.goal": "цель",
  "react.stat.alert": "тревога",
  "react.stat.systems": "системы",
  "react.stat.keys": "ключи",
  "react.stat.held": "при себе",
  "react.stat.banked": "на счету",
  "react.stat.hold": "в трюме",
  "react.stat.sortie": "вылет",
  "react.stat.lost": "потеряно дронов",
  "react.alert.charge": "заряд {room}",
  "react.next.here": "Эта стоянка",
  "react.next.rooms": "отсеков {n}",
  "react.next.machines": "машин {n}",
  "react.next.next": "Следующая стоянка",

  "react.rack.drone": "дрон",
  "react.rack.drones": "дроны",
  "react.rack.preview": "примерка",
  "react.room.unknown": "без данных",
  "react.here.empty": "здесь пусто",

  "react.menu.abandon": "бросит этот",
  "react.menu.settings": "Настройки",
  // Кто сделал игру, а не деньги на счету: счёт — это `panel.credits`.
  "react.menu.credits": "Авторы",
  "react.settings.motion": "Меньше движения",
  "react.settings.fromSystem": "как в системе",
  "react.credits.typefaces": "шрифты",
  "react.credits.debt": "в долгу перед",
  "react.controls.how": "как этим летать",

  "react.log.kept": "{n, one: # строка, few: # строки, many: # строк}",
  "react.stencil.seed": "сид {n}",
  "react.seed.set": "задать",

  "react.tug.alongside": "у борта",
  "react.tug.systems": "{up}/{of} в строю",
  "react.dock.back": "вернуть стойку на место",
  "react.dock.show": "показать его в стойке наверху",
  "react.dock.rails": "на рельсах",
  "react.hull.core": "ядро {n}",
  "react.hull.slots": "слотов {n}",
  "react.hull.speed": "скорость {n}",

  "verb.attack": "атаковать",
  "verb.salvage": "разобрать",
  "verb.carry": "унести",
  "verb.swap": "заменить",
  "verb.search": "обыскать",
  "verb.strip": "снять",
  "verb.work": "работать",
  "verb.take": "взять",
  "verb.upload": "передать",
  "verb.use": "пустить",
  "verb.bargain": "сделка",
  "verb.shoot": "стрелять",

  "react.page.prev": "раньше",
  "react.page.next": "дальше",
  "react.page.older": "старее",
  "react.page.newer": "свежее",
  "react.codex.what": "что это",
  "react.end.complete": "рейс завершён",
  "react.end.over": "рейс окончен",
  "react.end.seed": "?seed={seed} — тот же рейс, ход в ход.",
  "react.board.hint": "правая кнопка — панорама · наведи на отсек, покажет путь",

  "end.fig.sorties": "ВЫЛЕТЫ",
};
