...
export const RU: Table = {
  ...
  "hint.training": "ОБУЧЕНИЕ. Первый корпус рейса собран для учёбы. На нём игра скажет семь вещей, по одной за раз.",
  "hint.tutorial.enter": "УЧЕБНЫЙ КОРПУС. Маленький, тихий, забег на нём не кончишь. Всё, что умеет дрон, — в нумерованном списке.",
  ...
  "hint.tutorial.system": "Поднять систему — несколько ходов подряд и шум. Всё, что ещё на борту, это слышит и идёт сюда.",
  ...
  "panel.alertScuttle": "ТРЕВОГА {gauge} ПОДРЫВ {n}",
  ...
  "title.start": "1 — в рейс, как и любая клавиша не из этого списка",
  ...
  "codex.alert-4.what": "Корабль высылает охотника. Он идёт искать, режет заваренное и находит тебя в укрытии.",
  ...
  "codex.blade.what": "Две кости там, где у резака одна, и переборку он вскрывает ровно как резак.",
  ...
  "codex.shocker.what": "Три заряда, и каждый — тишина в этом отсеке на два хода, вместе с механизмами.",
  ...
  "codex.lattice.what": "Тридцать прочности и единственное постоянное очко брони во всей игре.",
