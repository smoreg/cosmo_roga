 ...
 * assumes that gesture has happened.
 */
...
/** Licence unresolved — see public/audio/ATTRIBUTION.md before any release. */
export const MENU_MUSIC: MusicTrack = {
  id: "menu",
  url: `${BASE}audio/music/menu-soft-millenium.mp3`,
...
export const MISSION_MUSIC: readonly MusicTrack[] = [
  {
    id: "blob",
    url: `${BASE}audio/music/The-Creeping-Blob_Looping.ogg`,
    title: "The Creeping Blob",
    credit: "Eric Matyas · soundimage.org",
  },
  {
    id: "factory",
    url: `${BASE}audio/music/Factory-On-Mercury_Looping.ogg`,
    title: "Factory On Mercury",
    credit: "Eric Matyas · soundimage.org",
  },
  {
    id: "eerie",
    url: `${BASE}audio/music/Eerie-Cyber-World_v001_Looping.ogg`,
    title: "Eerie Cyber World",
    credit: "Eric Matyas · soundimage.org",
  },
  {
    id: "dizzybot",
    url: `${BASE}audio/music/Dizzybot_Looping.ogg`,
    title: "Dizzybot",
    credit: "Eric Matyas · soundimage.org",
  },
  {
    id: "trouble",
    url: `${BASE}audio/music/Trouble-on-Mercury_Looping.ogg`,
